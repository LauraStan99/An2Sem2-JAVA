 ...
 */
    ...
    private void drawShape(int x, int y) {
        ...
        if(this.frame.shapes.availableShapes.getSelectedItem().equals("Polygon")){ graphics.fill(new RegularPolygon(x, y, radius, sides)); }
          else if(this.frame.shapes.availableShapes.getSelectedItem().equals("Circle")){graphics.fill(new Circle(x,y,radius));}
          else if(this.frame.shapes.availableShapes.getSelectedItem().equals("NewShape")){graphics.fill(new NewShape(x,y));}
